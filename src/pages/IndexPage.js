...
//import Footer from '@bit/paclife.egghead.footer';

const footerData = {
    "exploreLinks":[
        {
            "__typename":"ContentfulTopicLobeSection",
            "id":"dc96afa8-8eb9-56e9-b025-b8c94153c877",
            "title":"Innovation At Pacific Life",
            "sectionUrl":"https://hatchlabs.pacificlife.com/innovation",
            "component_navigation":null
        },
        {
            "__typename":"ContentfulTopicLobeSection",
            "id":"d6b8ddd5-0a74-5326-9dce-f9eccc81300c",
            "title":"About Hatch Labs",
            "sectionUrl":"https://hatchlabs.pacificlife.com/about",
            "component_navigation":null
        },
        {
            "__typename":"ContentfulTopicLobeSection",
            "id":"102d5301-c2a3-5c69-bce6-f0e112e60ba9",
            "title":"Our Work",
            "sectionUrl":"https://hatchlabs.pacificlife.com/our-work",
            "component_navigation":null
        },
        {
            "__typename":"ContentfulTopicLobeSection",
            "id":"bf81018e-6e65-578e-bd28-f3793b283581",
            "title":"Training & Resources",
            "sectionUrl":"https://hatchlabs.pacificlife.com/resources",
            "component_navigation":[
                {
                    "id":"14a6dfa6-e612-553d-8126-350f012ce24c",
                    "pageTitle":"Tool Directory",
                    "pageUrl":"https://hatchlabs.pacificlife.com/resources/tool-directory"
                },
                {
                    "id":"3c24060a-826f-56ba-96dc-4088c2d4a72e",
                    "pageTitle":"Templates",
                    "pageUrl":"https://hatchlabs.pacificlife.com/resources/templates"
                },
                {
                    "id":"47b01283-05ea-56bb-bb9c-1ee1d54a730f",
                    "pageTitle":"Playbooks",
                    "pageUrl":"https://hatchlabs.pacificlife.com/resources/playbooks"
                },
                {
                    "id":"c7e53dc2-4dbc-5125-bfab-d1bd70aa9c25",
                    "pageTitle":"Innovation Training",
                    "pageUrl":"https://hatchlabs.pacificlife.com/resources/training"
                }
            ]
        },
        {
            "__typename":"ContentfulPageChild"
        },
        {
            "__typename":"ContentfulPageChild"
        },
...
const Index = (props) => {
    ...
    const headerCollapse = {
        ...
        left: null,
        right: <span>
                <Link  href={'xpress/' + locale + '/about-us' } theme="red" size="xs" variant="light-gh" theme="red">
    ...
    const headerNavNavs = [
        {
            ...
            collapse: {
                left: [
                    <Link href={'/xpress/' + locale + '/postcode'} theme="red" variant="nav-red">
                            ...
                            <div class='col-md-8'>
                                <Blockquote
                                    ...
                                    body={
                                        ...
                                        <br /><br />
                                        <Button theme="red" variant="danger"  href={locale + '/request-pickup'} type="link"><I18n t="request_pickup" /></Button>
                                        </>
                                    }
                                />
                            </div>  
